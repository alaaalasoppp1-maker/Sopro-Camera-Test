...
public class MainActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle b) {
        ...
        append("Sopro Camera Player v0.5.3");
    ...
    private void startCamera(boolean forceRetryProfiles) {
        ...
        new Thread(() -> {
            ...
            for (VideoProfile vp: profiles) {
                ...
                boolean isoStarted = nativeIsoStart(fd, 0x82, selectedIsoPacketSize, 64, 8);
                append("Persistent ISO queue start = "+isoStarted+" errno="+nativeLastErrno());
                if (!isoStarted) {
                    stopBridgeCapture();
                    conn.setInterface(alt0);
                    continue;
